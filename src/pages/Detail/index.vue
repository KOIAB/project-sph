    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <!-- 服务器的数据还没回来，仓库中还没有，skuInfo.skuImageList这个不是一个数组而是undefine,直接[0]会报错，[0]后还要.所以要在数组中加个对象 -->
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd 
                  ...
                  @click="chaneActive(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前跳转路由，从AdaoB，这里加入购物车。进行路由跳转之前。发请求
                把你购物车的产品信息通过请求的形式通知服务器，服务器进行相应的存储 -->
...
<script>
  ...
  export default {
    ...
    methods:{
      // 产品售卖属性高亮切换
      chaneActive(spuSaleAttrValue,arr){
        // 遍历全部的售卖属性值
        arr.forEach(item=>{
          item.isChecked=0
        })
      ...
      // 表单元素修改产品个数
      changeSkuNum(event){
        // 用户输入的value*1,判断输入的是否为非数字，非数字就变成NaN
      ...
      async addShopcar(){
        ...
        try{
          ...
          // 2.服务器存储成功--进行路由跳转
          // 在路由跳转时还需要把产品的信息带过去,一些简单的数据可以通过query传过去，比较复杂的（skuInfo),通过会话存储（不持久化，会话结束数据消失）
